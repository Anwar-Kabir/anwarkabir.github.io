...
if ( ! function_exists( 'bosa_shopper_enqueue_styles' ) ) :
	/**
	 * @since Bosa Shopper 1.0.0
	 */
	function bosa_shopper_enqueue_styles() {
		wp_enqueue_style( 'bosa-shopper-style-parent', get_template_directory_uri() . '/style.css',
			array(
				'bootstrap',
				'slick',
				'slicknav',
		...
		wp_enqueue_style( 'bosa-shopper-google-fonts', "https://fonts.googleapis.com/css2?family=Jost:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap", false );
		wp_enqueue_style( 'bosa-shopper-google-fonts-two', "https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap", false );
	}

endif;
add_action( 'wp_enqueue_scripts', 'bosa_shopper_enqueue_styles', 1 );

/**
* Add cart link
* @since Bosa Shopper 1.0.0
*/
if ( !function_exists( 'bosa_shopper_cart_link' ) ) {
    function bosa_shopper_cart_link() {
        ?>	
...
* @since Bosa Shopper 1.0.0
*/
if ( !function_exists( 'bosa_shopper_header_cart' ) ) {
    function bosa_shopper_header_cart() {
        ?>
            <div class="header-cart">
                <div class="header-cart-block">
                    <div class="header-cart-inner">
                        <?php bosa_shopper_cart_link(); ?>
...
* @since Bosa Shopper 1.0.0
*/
if ( !function_exists( 'bosa_shopper_header_add_to_cart_fragment' ) ) {
    function bosa_shopper_header_add_to_cart_fragment( $fragments ) {
        ob_start();
        bosa_shopper_cart_link();
        $fragments['a.cart-icon'] = ob_get_clean();
        return $fragments;
    }
    add_filter( 'woocommerce_add_to_cart_fragments', 'bosa_shopper_header_add_to_cart_fragment' );
}
...
* @since Bosa Shopper 1.0.0
*/
if ( !function_exists( 'bosa_shopper_head_wishlist' ) ) {
    function bosa_shopper_head_wishlist() {
            ...
            <div class="header-wishlist">
                <a href="<?php echo esc_url( $wishlist_url ); ?>">
                    ...
                    <span class="info-tooltip">
                        <?php esc_html_e( 'Wishlist', 'bosa-shopper' ); ?>
                    </span>
                </a>
            </div>
            <?php
...
* @since Bosa Shopper 1.0.0
*/
if (!function_exists( 'bosa_shopper_head_compare' ) ) {
    function bosa_shopper_head_compare() {
        if ( function_exists( 'yith_woocompare_constructor' ) ) {
            ...
            <div class="header-compare">
                <a class="compare added" rel="nofollow" href="<?php echo esc_url( $yith_woocompare->obj->view_table_url() ); ?>">
                    ...
                    <span class="info-tooltip">
                        <?php esc_html_e( 'Compare', 'bosa-shopper' ); ?>
                    </span>
                </a>
            </div>
            <?php
...
* @since Bosa Shopper 1.0.0
*/
if ( !function_exists( 'bosa_shopper_my_account' ) ) {
    function bosa_shopper_my_account() {
            ...
            <div class="header-my-account">
                <div class="header-login"> 
                    <a href="<?php echo esc_url( get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ); ?>">
                        ...
                        <span class="info-tooltip">
                            <?php esc_html_e( 'My Account', 'bosa-shopper' ); ?>
                        </span>
                    </a>
                </div>
            </div>
...
* @return array.
*/
function bosa_shopper_get_pages(){
    ...
    function bosa_shopper_blog_advertisement_banner(){
        ...
        if ( is_array(  $blog_advertisement_banner_obj ) ){
            ...
            <div class="section-advert">
                <a href="<?php echo esc_url( get_theme_mod( 'blog_advertisement_banner_link', '#' ) ); ?>" alt="<?php echo $alt; ?>" target="<?php echo esc_attr( $advert_target ); ?>">
...
if ( ! function_exists( 'bosa_shopper_grid_thumbnail_date' ) ) :
    /**
     * Prints HTML with meta information for the tags and comments.
     */
    function bosa_shopper_grid_thumbnail_date() {
                    ...
                    comments_popup_link(
                        sprintf(
                            wp_kses(
                                ...
                                __( 'Comment<span class="screen-reader-text"> on %s</span>', 'bosa-shopper' ),
                                array(
                                    'span' => array(
                                        'class' => array(),
                                    ),
