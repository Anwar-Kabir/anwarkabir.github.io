...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<?php bosa_shopper_blog_advertisement_banner(); ?>
					...
					<div class="row">
						<?php
							...
							if ( get_theme_mod( 'sidebar_settings', 'right' ) == 'right' ){
								...
								if( get_theme_mod( 'archive_post_layout', 'grid-thumbnail' || get_theme_mod( 'archive_post_layout', 'grid-thumbnail' ) == 'grid-thumbnail' ) == 'grid'){
							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-shopper' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-shopper' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-shopper' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-shopper' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-shopper' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
