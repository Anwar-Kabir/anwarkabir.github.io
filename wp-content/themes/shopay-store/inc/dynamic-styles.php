...
add_action( 'wp_enqueue_scripts', 'shopay_store_dynamic_styles', 99 );

if ( ! function_exists( 'shopay_store_dynamic_styles' ) ) :

    function shopay_store_dynamic_styles() {

        $shopay_primary_color = get_theme_mod( 'shopay_primary_color', '#FED700' );
        ...
        wp_add_inline_style( 'shopay-store-style', $refine_output_css );
    }
